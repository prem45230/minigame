...
function reset_image() {
    ...
    document.getElementById('tab-grid').style.background = '';
    number_mvs = 0;
    document.getElementById('move').textContent = 'Move: 0';
    count = 0;
}
...
function back_to_normal() {
    setTimeout(reset_image, 1000);
}

function back_to_normal2() {
    reset_image();
}
                ...
                case 'p33':
                    ...
                    if (check_win()) {
                        setTimeout(function() {
                            ...
                            document.getElementById('tab-grid').style.background = 'url("https://raw.githubusercontent.com/Only0nce/puzzle/main/success.gif")';
                        }, 500)
                    }
